...
Route::group(['middleware' => ['navigation','login']], function () {
    ...
    Route::group(['middleware' => ['role:admin']], function () {
        ...
        Route::get('/loading-buttons', function () {     return view('dashboard.loading-buttons'); }); //PRO
        Route::get('/multi-select', function () {     return view('dashboard.multi-select'); }); //PRO
        Route::get('/advanced-forms', function () {     return view('dashboard.advanced-forms'); }); //PRO
        Route::get('/validation', function () {     return view('dashboard.validation'); }); //PRO
        Route::get('/toastr', function () {     return view('dashboard.toastr'); }); //PRO
        Route::get('/datatables', function () {     return view('dashboard.datatables'); }); //PRO
