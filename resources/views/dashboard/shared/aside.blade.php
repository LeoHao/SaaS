            ...
            <div class="list-group list-group-accent">
              ...
              <div class="list-group-item list-group-item-accent-danger list-group-item-divider">
                ...
                <div class="avatars-stack mt-2">
                  ...
                  <div class="avatar avatar-xs">
                    <img class="img-avatar" src="{{ asset('assets/img/avatars/3.jpg')}}" alt="admin@bootstrapmaster.com">
                  </div>
                  <div class="avatar avatar-xs">
                    <img class="img-avatar" src="{{ asset('assets/img/avatars/4.jpg') }}" alt="admin@bootstrapmaster.com">
                  </div>
              ...
              <div class="list-group-item list-group-item-accent-primary list-group-item-divider">
                ...
                <div class="avatars-stack mt-2">
                  ...
                  <div class="avatar avatar-xs">
                    <img class="img-avatar" src="{{ asset('assets/img/avatars/5.jpg') }}" alt="admin@bootstrapmaster.com">
                  </div>
                  <div class="avatar avatar-xs">
